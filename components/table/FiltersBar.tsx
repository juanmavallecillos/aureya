...
// const FacetCard: React.FC<React.PropsWithChildren<{ className?: string }>> = ({
//   className,
//   children,
// }) => (
//   <div
...
// /* Fila de chips SIN scroll horizontal; permite salto de línea */
// const ScrollRow: React.FC<React.PropsWithChildren<{ className?: string }>> = ({
//   className,
//   children,
// }) => (
...
//       {!hideMetalFacet && (
//         <FacetCard>
//           <FacetTitle icon={<Gem className="h-3.5 w-3.5 text-zinc-500" />}>
//             Metal
//           </FacetTitle>
//           <ScrollRow>
//             <Chip
...
//       {!hideFormFacet && (
//         <FacetCard>
//           <FacetTitle icon={<Shapes className="h-3.5 w-3.5 text-zinc-500" />}>
//             Formato
//           </FacetTitle>
//           <ScrollRow>
//             <Chip
...
//       {!hideBucketFacet && (
//         <FacetCard>
//           <FacetTitle icon={<Ruler className="h-3.5 w-3.5 text-zinc-500" />}>
//             Tamaño
//           </FacetTitle>
//           <ScrollRow>
//             <Chip
...
//       {!hideDealerFacet && (
//         <FacetCard>
//           <FacetTitle icon={<Store className="h-3.5 w-3.5 text-zinc-500" />}>
//             Tienda
//           </FacetTitle>
//           <ScrollRow>
//             <Chip
...
//                       {dealerCounts[d] ? (
//                         <span className="opacity-70">({dealerCounts[d]})</span>
//                       ) : null}
//                     </span>
//                   </Chip>
//                 );
